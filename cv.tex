...
\cvitem{Software}{Designer or co-designer of Phyelds and ScaRLib. See \hyperref[sec:software]{Research Software}.}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item Number of \quartilebadge{Q1} journal publications: 5.
    \item Number of \quartilebadge{Q2} journal publications: 2.
    % \item Number of \quartilebadge{Q3} journal publications: ??.
  \end{itemize}
\end{itemize}
All my publications (ordered by venue and year DESC) follow.
...
\cvitem{Summary}{121 documented course hours through 2026, across degree courses at the University of Bologna and invited teaching at PhD schools and partner universities.}
