...
\cvitem{Research record}{\textbf{24 publications}: 8 journal articles, 12 conference papers, 3 workshop papers, and 1 preprints. \textbf{H-index 8 with 116 citations} on Google Scholar; h-index 5 with 77 citations on Scopus (as of \cvmetricsdate). See \hyperref[sec:publications]{Publications}. \textbf{Program Chair} of AI4AS 2026. See \hyperref[sec:research-activity]{Conference Service}}
...
\cventry{September 2026}{Best Companion Artifact Award}{ACSOS 2026}{}{}{\emph{Multi-Target Tracking via Field-Based Distributed Particle Filtering}~\citeconferences{cortecchia2026dpf}.}
...
\begin{itemize}
  \item \textbf{H-index:} 8 (Google Scholar), 5 (Scopus), as of \cvmetricsdate.
  \item \textbf{Number of citations:} 116 (Google Scholar), 77 (Scopus), as of \cvmetricsdate.
  \item \textbf{Number of publications:} 24 (8 journal articles, 12 conference papers, 3 workshop papers, 1 preprint).
  \item \textbf{Number of journal publications:} 8.
  \begin{itemize}
    \item Number of \quartilebadge{Q1} journal publications: 4.
    \item Number of \quartilebadge{Q2} journal publications: 2.
  \item Number of \quartilebadge{Q3} journal publications: 2.
  \end{itemize}
\end{itemize}
